...
export function makeHair(mats){
 ...
 for(let i=0;i<12;i++){const x=-.57+i*.10;const lock=ribbon([[x*.7,.91,.16],[x+.18,.72,.52],[x+.12,.39,.64],[x-.08,.21-Math.abs(x)*.6,.62]],.20,mats.hairCard,i%3?'#332a31':'#483a40');root.add(lock);}
