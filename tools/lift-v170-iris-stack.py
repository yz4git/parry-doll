...
indices, hierarchy and node transforms remain untouched.  Visible iris colour is supplied by the
eye-texture pass; this depth fix only resolves the known ~1 mm burial inside the old sclera globe.
"""
