...
for side in(-1,1):
 ...
 add_profile_ellipse_yz_v137(HEAD,f'EyeProfileScleraYZV140_{side}',ex+side*eye_rx*.870,eye_y+.0001,.1025,eye_ry*1.055,.00810,SCLERA,46)
 add_profile_ellipse_yz_v137(HEAD,f'EyeProfileIrisYZV137_{side}',ex+side*eye_rx*.880,eye_y+.0002,.10345,eye_ry*.670,.00505,IRIS_INNER,42)
 add_profile_ellipse_yz_v137(HEAD,f'EyeProfilePupilYZV137_{side}',ex+side*eye_rx*.886,eye_y+.0001,.10390,eye_ry*.312,.00242,PUPIL,32)
 ...
 add_strand(HEAD,f'ProfileUpperLidV140_{side}',[(ex+side*eye_rx*.894,eye_y+eye_ry*.74,.1019),(ex+side*eye_rx*.896,eye_y+eye_ry*.33,.10715),(ex+side*eye_rx*.896,eye_y-.0001,.10865)],.00024*eye_contrast,FACE_DARK)
 ...
 add_strand(HEAD,f'ProfileLashFanV138_A_{side}',[(outer-side*.0008,eye_y+eye_tilt+.0035,.10435),(outer+side*.0018,eye_y+eye_tilt+.0072,.1072),(outer+side*.0035,eye_y+eye_tilt+.0078,.1104)],.00027*eye_contrast,HAIR)
 add_strand(HEAD,f'ProfileLashFanV138_B_{side}',[(outer-side*.0005,eye_y+eye_tilt+.0026,.10430),(outer+side*.0020,eye_y+eye_tilt+.0038,.1078),(outer+side*.0040,eye_y+eye_tilt+.0028,.1100)],.00023*eye_contrast,HAIR)
