...
add_profile_head_v55(HEAD,'HeadShellV55',[
 (-.142,.038,.050,.064),
 (-.133,.058,.064,.078),
 (-.122,.078,.078,.096),
 (-.110,.094,.086,.104),
...
# Anatomy v5.5: compact adult eyes seated in the recessed single-shell orbit.
face_front=.0848
eye_y=.0300
eye_x=head_w*.147
eye_rx=head_w*.098
...
# Hair v5.5: upper scalp cap closes crown gaps; layered sweep sits over it; smooth pony is retained.
