...
# Anatomy v4.1: smaller inset eyes and stronger 3D central facial volumes.
...
# Hair v4.1: asymmetric side-swept fringe with fewer, broader locks.
...
# Consolidated ponytail v4.1: layered mass with a gentle rightward sweep.
