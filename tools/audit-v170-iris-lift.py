...
def main():
 ...
 print('V170_IRIS_LIFT_AUDIT',json.dumps({'revision':'v17.0-eye-texture-plus-iris-depth-fix','changed_position_accessors':changed,'changed_accessor_count':len(changed),'unchanged_position_accessor_count':unchanged,'x_y_unchanged':True,'non_eye_geometry_unchanged':True,'head_geometry_unchanged':True,'sclera_geometry_unchanged':True,'node_hierarchy_and_transforms_unchanged':True,'topology_unchanged':True,'eye_textures':names},sort_keys=True))
