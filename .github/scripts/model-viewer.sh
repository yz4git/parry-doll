...
(()=>{
 ...
 const open=document.createElement('button');open.id='modelViewerOpen';open.type='button';open.innerHTML='モデルを見る<small>MODEL VIEWER</small>';start.insertAdjacentElement('afterend',open);
