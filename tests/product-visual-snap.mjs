...
await page.locator('#start').tap({force:true,timeout:5000});
...
await page.locator('#parry').tap({force:true}); await page.waitForTimeout(750);
...
await page.locator('#dodge').tap({force:true}); await page.waitForTimeout(450);
