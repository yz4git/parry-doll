...
(()=>{
 ...
 window.parryChainDestructionDiagnostics=()=>{animateCollapse(performance.now());return{v13:true,triggers:s.triggers,last:s.last?{...s.last}:null,armed:!!s.launch,power:s.launch?.power||0,checks:s.checks,collapse:!!s.collapse,settled:!!s.collapse?.settled,consumed:[...s.consumed]}};
})();
