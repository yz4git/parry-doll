...
(()=>{
 ...
 #mbFinalAura{position:fixed;inset:0;z-index:4;pointer-events:none;opacity:0;transition:opacity .32s;background:radial-gradient(circle at 50% 44%,rgba(255,92,164,.13),transparent 31%),linear-gradient(180deg,rgba(210,246,255,.035),transparent 35%,rgba(255,82,96,.025));mix-blend-mode:screen}
