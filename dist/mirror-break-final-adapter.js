...
// V2/V3/V4/V5/UI/V6/V7/V8/V9 deliberately load after every v1/final wrapper so the newest
// presentation, persistent damage, DOLL CORE styles, CORE ECHO, KO reward pacing and Boss Destruction compose last.
(()=>{if(window.__parryMirrorBreakV2Queued)return;window.__parryMirrorBreakV2Queued=true;const src=document.currentScript?.src||'',q=src.includes('?')?'?'+src.split('?').slice(1).join('?'):'',s=document.createElement('script');s.src='./mirror-break-v2.js'+q;s.onload=()=>{if(window.__parryMirrorBreakV3Queued)return;window.__parryMirrorBreakV3Queued=true;const v3=document.createElement('script');v3.src='./mirror-break-v3.js'+q;v3.onload=()=>{if(window.__parryMirrorBreakV4Queued)return;window.__parryMirrorBreakV4Queued=true;const v4=document.createElement('script');v4.src='./mirror-break-v4.js'+q;v4.onload=()=>{if(window.__parryMirrorBreakV5Queued)return;window.__parryMirrorBreakV5Queued=true;const v5=document.createElement('script');v5.src='./mirror-break-v5.js'+q;v5.onload=()=>{if(window.__parryMirrorBreakV5UiQueued)return;window.__parryMirrorBreakV5UiQueued=true;const ui=document.createElement('script');ui.src='./mirror-break-v5-ui.js'+q;ui.onload=()=>{if(window.__parryMirrorBreakV6Queued)return;window.__parryMirrorBreakV6Queued=true;const v6=document.createElement('script');v6.src='./mirror-break-v6.js'+q;v6.onload=()=>{if(window.__parryMirrorBreakV7Queued)return;window.__parryMirrorBreakV7Queued=true;const v7=document.createElement('script');v7.src='./mirror-break-v7.js'+q;v7.onload=()=>{if(window.__parryMirrorBreakV8Queued)return;window.__parryMirrorBreakV8Queued=true;const v8=document.createElement('script');v8.src='./mirror-break-v8-defeat-presentation.js'+q;v8.onload=()=>{if(window.__parryMirrorBreakV9Queued)return;window.__parryMirrorBreakV9Queued=true;const v9=document.createElement('script');v9.src='./mirror-break-v9-boss-destruction.js'+q;document.body.appendChild(v9)};document.body.appendChild(v8)};document.body.appendChild(v7)};document.body.appendChild(v6)};document.body.appendChild(ui)};document.body.appendChild(v5)};document.body.appendChild(v4)};document.body.appendChild(v3)};document.body.appendChild(s)})();
