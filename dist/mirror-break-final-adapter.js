...
// V2/V3/V4/V5 deliberately load after every v1/final wrapper so the latest presentation,
// persistent-damage and post-break behavior layers compose last.
(()=>{if(window.__parryMirrorBreakV2Queued)return;window.__parryMirrorBreakV2Queued=true;const src=document.currentScript?.src||'',q=src.includes('?')?'?'+src.split('?').slice(1).join('?'):'',s=document.createElement('script');s.src='./mirror-break-v2.js'+q;s.onload=()=>{if(window.__parryMirrorBreakV3Queued)return;window.__parryMirrorBreakV3Queued=true;const v3=document.createElement('script');v3.src='./mirror-break-v3.js'+q;v3.onload=()=>{if(window.__parryMirrorBreakV4Queued)return;window.__parryMirrorBreakV4Queued=true;const v4=document.createElement('script');v4.src='./mirror-break-v4.js'+q;v4.onload=()=>{if(window.__parryMirrorBreakV5Queued)return;window.__parryMirrorBreakV5Queued=true;const v5=document.createElement('script');v5.src='./mirror-break-v5.js'+q;document.body.appendChild(v5)};document.body.appendChild(v4)};document.body.appendChild(v3)};document.body.appendChild(s)})();
