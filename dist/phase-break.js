...
(()=>{
 ...
 function ensureUI(){
  ...
  style.textContent=`
   ...
   #pbDanger.show{opacity:1;transform:translateX(-50%) scale(1)}#pbDanger strong{color:#ff5260;margin-right:6px}
   ...
   #pbResolve{position:absolute;left:max(25px,env(safe-area-inset-left));bottom:220px;width:155px;pointer-events:none}#pbResolve label{display:flex;justify-content:space-between;font-size:8px;letter-spacing:1.7px;color:#9ebeb8;margin-bottom:3px}#pbResolve .track{height:3px;background:#071017c9}.track i{display:block;width:0;height:100%;background:linear-gradient(90deg,#ff5ca4,#ff5260);box-shadow:0 0 8px #ff5ca477;transition:width .15s}
   #pbBanner{position:absolute;left:0;right:0;top:34%;text-align:center;pointer-events:none;opacity:0;transform:scale(.88);transition:opacity .14s,transform .14s;text-shadow:0 3px 18px #000}#pbBanner.show{opacity:1;transform:scale(1)}#pbBanner small{display:block;font-size:10px;letter-spacing:5px;color:#ff5260}#pbBanner b{display:block;margin-top:5px;font-size:26px;letter-spacing:8px;color:#ff5260}
